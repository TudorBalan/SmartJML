...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            CharStream input = CharStreams.fromFileName("src/test/java/sources/testInput.sl");
            ...
            Files.write(Paths.get("src/test/java/sources/testOutput.java"), translation.toString().getBytes());
        } catch (IOException e) {
